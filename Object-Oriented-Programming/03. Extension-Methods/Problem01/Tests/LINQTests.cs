namespace Problem01.Tests
{
    ...
    using Problem01.LINQ;
    using Problem01.Extensions;
    ...
    public static class LINQTests
    {
        public static void Test()
        {
            ...
            result = LINQs.FirstBeforeLast(students);
            result.ForEach(x => Console.WriteLine(x.FullName));
            PrintLine();
            ...
            otherResult = LINQs.InAgeRange(students, 18, 25);
            otherResult.ForEach(x => Console.WriteLine(x));
            PrintLine();
            ...
            result = LINQs.StudentsSort(students);
            result.ForEach(x => Console.WriteLine(x.FullName));
            PrintLine();
            ...
            var numResult = numbers.DividebleBySevenAndThree();
            PrintNumbers(numResult);
            
            numResult = LINQs.DividebleBySevenAndThree(numResult);
            PrintNumbers(numResult);
        }
        ...
        public static void Test2()
        {
            ...
            var result = LINQs.StudentsFromGroup(students, 2);
            result
                .OrderBy(x => x.FirstName)
                .ForEach(x => Console.WriteLine($"{x.FullName} group: {x.GroupNumber}"));
            PrintLine();
            ...
            result = LINQs.StudentsByMailDomain(students, "abv.bg");
            result
                .ForEach(x => Console.WriteLine($"{x.FullName} mail: {x.Mail}"));
            PrintLine();
            ...
            result = LINQs.StudentsByPhone(students, 2, "2");
            result
                .ForEach(x => Console.WriteLine($"{x.FullName} tel.: {x.Tel}"));
            PrintLine();
        }
        ...
        {
            var students = HardCodeStudents();
            var result = LINQs.StudentsByGroups(students);
            result
                .ForEach(x =>
                {
